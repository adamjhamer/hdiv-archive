...
public class OptionTagHDIV extends OptionTag {
	 ...
	 */
	private static final String VALUE_ATTRIBUTE = OptionTag.VALUE_VARIABLE_NAME;
	...
	private void renderOption(Object value, String label, TagWriter tagWriter) throws JspException {
		...
		String hdivValue = dataComposer.compose(selectTag.getName(), renderedValue, false);				

		tagWriter.writeAttribute(VALUE_ATTRIBUTE, hdivValue);
	...
	private boolean isSelected(Object resolvedValue) {
		return SelectedValueComparatorHDIV.isSelected(getBindStatus(), resolvedValue);
	}
