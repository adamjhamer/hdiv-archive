...
class OptionWriterHDIV {
	...
	private final IDataComposer dataComposer;
	 ...
	 * (optional)
	 */
	public OptionWriterHDIV(IDataComposer dataComposer, String selectName,
	...
	private void renderOption(TagWriter tagWriter, Object item, Object value, Object label) throws JspException {
		...
		String hdivValue = this.dataComposer.compose(this.selectName, valueDisplayString, false);
	...
	private String getDisplayString(Object value) {
		...
		return ValueFormatterHDIV.getDisplayString(value, editor, this.htmlEscape);
	}
	...
	private boolean isOptionSelected(Object resolvedValue) {
		return SelectedValueComparatorHDIV.isSelected(this.bindStatus, resolvedValue);
	}
