...
/**
 * <p>
 * Support for tag handlers for &lt;redirect&gt;, JSTL 1.0's tag for redirecting to a
 * new URL (with optional query parameters).
 * </p>
 * 
...
//		
//		if (!HDIVRequestUtils.hasExtensionToExclude(result, hdivConfig.getExcludedURLExtensions()))
//		{
//			if (HDIVRequestUtils.hasActionOrServletExtension(result, hdivConfig.getProtectedURLPatterns())) {
//				result = HDIVRequestUtils.addHDIVParameterIfNecessary((HttpServletRequest) pageContext.getRequest(), 
//						result, hdivConfig.isValidationInUrlsWithoutParamsActivated());
//			}
//		}
