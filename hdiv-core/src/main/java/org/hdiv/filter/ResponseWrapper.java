...
public class ResponseWrapper extends HttpServletResponseWrapper {
	...
	public ResponseWrapper(HttpServletResponse originalResponse) {
		...
		this.confidentiality = ((Boolean) HDIVUtil.getApplication().getBean("confidentiality")).booleanValue();
		this.avoidCookiesConfidentiality = ((Boolean) HDIVUtil.getApplication().getBean("avoidCookiesConfidentiality")).booleanValue();
	}
