...
<div id="bookingForm">
	...
	<div class="span-12 last">
		...
		<fieldset>
			...
			<div>
				<form:submit cssClass="button" name="_eventId_confirm" value="Confirm"/>
				<form:submit cssClass="button" name="_eventId_revise" value="Revise"/>
				<form:submit cssClass="button" name="_eventId_cancel" value="Cancel"/>
				<%-- 
