...
/**
 * PhaseListener that executes request validation. It uses a
 * ValidationHelper for that.
 * 
...
public class ValidationPhaseListener implements PhaseListener {
	...
	public void afterPhase(PhaseEvent event) {
		...
		try {
			...
			log.info("Error in the request validation. Msg:" + e.getMessage());
			try {
				...
				log.info("Error in the request validation. Msg:" + ex.getMessage());
