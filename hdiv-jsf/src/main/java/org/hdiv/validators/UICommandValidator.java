...
public class UICommandValidator implements ComponentValidator {
	...
	public ValidationError validate(UIComponent component) {
		...
		for (Iterator it = component.getChildren().iterator(); it.hasNext();) {
			UIComponent childComp = (UIComponent) it.next();
	 ...
	 * @param rowIndex
	 * 			  index that shows where it is the UICommand component inside
	 * 			  a UIData
	...
	private ValidationError processParam(UIParameter parametro, int rowIndex) {
		...
		Map requestMap = fContext.getExternalContext().getRequestParameterMap();
		String requestValue = (String) requestMap.get(param.getName());
