 ...
 * <ul>
 * <li>
 * If it is a JSF request (with JSF state) doesn't do any validation. 
 * If it is a HDIV request (with HDIV state) delegates validation to core's
 * validation helper.
 * </li>
 * <li>
 * isTheSameAction() method is overwritten because action checking changes.
 * </li>
 * <li>
 * addParameterToRequest(..) method is overwritten because in the JSF version
 * confidentiality is disabled and RequestWrapper is not used. Consecuently,
 * no parameter is added to the request.  
 * </li>
 * <ul>
 * 
...
public class JsfValidatorHelper extends ValidatorHelperRequest {
	 ...
	 * 
	 * @see
	 * org.hdiv.filter.AbstractValidatorHelper#preValidate(javax.servlet.http
	 ...
	 * 
	 * @see
	 * org.hdiv.filter.AbstractValidatorHelper#isTheSameAction(javax.servlet
	 * .http.HttpServletRequest, java.lang.String, org.hdiv.state.IState)
	 */
	 ...
	 * 
	 * @see
	 * org.hdiv.filter.AbstractValidatorHelper#addParameterToRequest(javax.servlet
