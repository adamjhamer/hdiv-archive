...
/**
 * Wrapper of FacesContextFactory to create new instances of FacesContext.
 * Returns a Hdiv's proprietary FacesContext instance which is a wrapper of the original instance  
